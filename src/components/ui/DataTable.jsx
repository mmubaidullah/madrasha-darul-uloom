          ...
          <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            <div>
              <p className="text-sm text-gray-700">
                মোট <span className="font-medium">{data.length}</span> টি এন্ট্রি থেকে{' '}
                <span className="font-medium">{startIndex + 1}</span> থেকে{' '}
                <span className="font-medium">{Math.min(endIndex, data.length)}</span> দেখানো হচ্ছে
              </p>
            </div>
